...
const CardEventUniq = () => {
  return (
    <section>
      <div className="max-w-sm rounded-3xl overflow-hidden shadow-lg bg-lightbrown group transform cursor-pointer  border  transition-colors duration-300 hover:border-transparent hover:bg-orangee">
        <div className="flex space-x-36 px-6 py-4">
          ...
          <div className=" pt-2">
            <div className=" justify-items-center font-semibold bg-slate-700 text-white rounded-full text-sm  ">
